...
silencer_lips_number		= 0;	/* Number of lips */
silencer_lips_rounded		= 1;	/* Are they rounded, and how much.. */
silencer_lips_fn		= 20;	/* Number of faces for the lip cylinder. Can be = $fn */

silencer_soundtrap_decal 	= silencer_struct_thickness * 7.0;	/* attack angle */
silencer_soundtrap_start	= 16;	/* Start of the soundtraps, must be > silencer_thread_len */
silencer_soundtrap_size 	= 1.26;	/* Ratio on caliber */
