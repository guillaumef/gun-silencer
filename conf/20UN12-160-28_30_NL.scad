...
silencer_tube_int_dia		=  28;	/* tube internal diameter */
silencer_tube_ext_dia		=  30;	/* tube external diameter. Can be equal to int_dia */
silencer_tube_barrel_dia	=  silencer_tube_int_dia; /* straight tube */
...
silencer_lips_number		= 0;	/* External lips in contact with the tube.
...
silencer_lips_groove		= 0;	/* Add a groove for an o-ring on each lip: this is the thickness
					   ...
					   silencer_lips_groove/2 to let the o-ring have a nice compression.
					 */

/* Baffles */
silencer_baffle_decal 		= silencer_struct_thickness * 7.0;	/* attack angle */
silencer_baffle_start		= 16;	/* Start of the baffles, must be > silencer_thread_len */
silencer_baffle_size 		= 1.26;	/* Ratio on caliber */
